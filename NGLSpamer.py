...
███╗░░██╗░██████╗░██╗░░░░░
████╗░██║██╔════╝░██║░░░░░                   Instagram: muhammadilhamrizki_99
██╔██╗██║██║░░██╗░██║░░░░░            TOOLS INI HANYA DI BUAT UNTUK MENGUJI KEAHLIAN
██║╚████║██║░░╚██╗██║░░░░░                            By:ILHAM M RIZKI
██║░╚███║╚██████╔╝███████╗                   
╚═╝░░╚══╝░╚═════╝░╚══════╝
𝗡𝗚𝗟 𝗦𝗣𝗔𝗠 𝗩𝟭 
    ...
    nglusername = input(Colorate.Vertical(Colors.white,"Username: "))
    message = input(Colorate.Vertical(Colors.white,"Message: "))
    Count = int(input(Colorate.Vertical(Colors.white,"Count: ")))
    delay = float(input(Colorate.Vertical(Colors.white,"Delay between requests (enter 0 if you want the fastest in seconds): ")))
    use_proxy = input(Colorate.Vertical(Colors.white, "Use proxy? (y/n): ")).lower()
